...
if __name__ == '__main__':
    ...
    parser.add_argument("-bert_data_path", default='/home/zgb/wangxin/bert_pre2/bert_pre2/ss2')
    parser.add_argument("-model_path", default='../models/bert_abs')
    parser.add_argument('-log_file', default='../logs/bert_test_abs_20191016.log')
    parser.add_argument("-result_path", default='../results/bert_abs_res_20191016')
    ...
    parser.add_argument("-test_from", default='/home/zgb/PycharmProjects/NAV_Xin/models/bert_abs/model_step_400000.pt')
